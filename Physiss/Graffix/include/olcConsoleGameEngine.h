...
public:
	...
	/// <summary>
	/// Draws a triangle wireframe with given coordinates.
	/// <para>x1,y1 first angle position</para>
	/// <para>x2,y2 second angle position</para>
	/// <para>x3,y3 third angle position</para>
	/// </summary>
	...
	/// <summary>
	/// Draws a solid triangle with given coordinates.
	/// <para>x1,y1 first angle position</para>
	/// <para>x2,y2 second angle position</para>
	/// <para>x3,y3 third angle position</para>
	/// <para>https://www.avrfreaks.net/sites/default/files/triangles.c</para>
	/// </summary>
